              ...
              {applications.map((app) => {
                ...
                return (
                  <div key={app.id} className="rounded-[16px] border border-border bg-panel p-5 relative overflow-hidden shadow-lg hover:border-brand/25 transition duration-300">
                    ...
                    {stage === "hired" && (
                      <div className="mt-5 rounded-xl border border-success/25 bg-success/5 p-4 animate-in fade-in duration-300 relative z-10 text-left">
                        <div className="flex items-center gap-1.5 text-xs font-bold text-success mb-2 animate-pulse">
                          🎉 Offer & Onboarding Active
                        </div>
                        <p className="text-[11px] leading-relaxed text-muted-foreground font-semibold">
                          Congratulations! You cleared all communication and technical speech signal rounds with an impressive AI rating. Check your registered inbox ({profile?.email || "email"}) for your formal offer details and official team onboarding steps!
                        </p>
                      </div>
                    )}
                    ...
                    {stage !== "hired" && !isRejected && (
                      <div className="mt-5 rounded-xl border border-border bg-card/35 p-4 animate-in fade-in duration-300 relative z-10 text-left">
