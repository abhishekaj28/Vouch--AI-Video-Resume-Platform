    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center" style={{ perspective: "1000px" }}>
        <div
          ...
          className="w-full max-w-sm h-[480px] rounded-[24px] border border-brand bg-gradient-to-b from-[#181a25] to-[#0d0e14] p-5 shadow-[0_0_40px_rgba(245,197,24,0.18)] relative overflow-hidden transition-all duration-500 transform hover:rotate-y-6 hover:rotate-x-6 hover:scale-[1.02] transform-style-3d cursor-pointer group"
        >
